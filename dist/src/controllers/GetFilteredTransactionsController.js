...
class GetFilteredTransactionsController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = date ? useCase.getTransactionsByDate(date, filteredTransactions) : filteredTransactions;
            return response.json(result);
        });
    }
}
exports.GetFilteredTransactionsController = GetFilteredTransactionsController;
//# sourceMappingURL=GetFilteredTransactionsController.js.map